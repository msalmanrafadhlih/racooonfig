...
VAR_FILE="$DIR/rices/shapes/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/shapes/modules"
MAIN_CONFIG="$DIR/rices/shapes/preview.ini"
...
find "$DIR/rices/shapes/scripts" -type f -exec chmod +x {} +
