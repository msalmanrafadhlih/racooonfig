...
VAR_FILE="$DIR/rices/colorblocks/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/colorblocks/modules"
MAIN_CONFIG="$DIR/rices/colorblocks/preview.ini"
...
find "$DIR/rices/colorblocks/scripts" -type f -exec chmod +x {} +
