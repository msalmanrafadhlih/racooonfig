...
VAR_FILE="$DIR/rices/forest/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/forest/modules"
MAIN_CONFIG="$DIR/rices/forest/preview.ini"
...
find "$DIR/rices/forest/scripts" -type f -exec chmod +x {} +
