...
VAR_FILE="$DIR/rices/shades/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/shades/modules"
MAIN_CONFIG="$DIR/rices/shades/preview.ini"
...
find "$DIR/rices/shades/scripts" -type f -exec chmod +x {} +
