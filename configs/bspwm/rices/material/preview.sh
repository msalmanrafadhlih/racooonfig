...
VAR_FILE="$DIR/rices/material/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/material/modules"
MAIN_CONFIG="$DIR/rices/material/preview.ini"
...
find "$DIR/rices/material/scripts" -type f -exec chmod +x {} +
