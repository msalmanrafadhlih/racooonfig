...
VAR_FILE="$DIR/rices/blocks/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/blocks/modules"
MAIN_CONFIG="$DIR/rices/blocks/preview.ini"
...
find "$DIR/rices/blocks/scripts" -type f -exec chmod +x {} +
