...
VAR_FILE="$DIR/rices/grayblocks/.var"
TMP_CONFIG="/tmp/polybar_${UID}.ini"

SHARED="$HOME/.config/polybar/shared"
MODULES="$DIR/rices/grayblocks/modules"
MAIN_CONFIG="$DIR/rices/grayblocks/preview.ini"
...
find "$DIR/rices/grayblocks/scripts" -type f -exec chmod +x {} +
